...
- **No persisted secrets or user data**: Device tokens and trigger plaintext are not persisted; the current compatibility replay state stores only public gift-wrap event IDs and processing timestamps
